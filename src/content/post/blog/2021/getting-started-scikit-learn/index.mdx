...
If you'd like to get it done in 90 seconds or less, I made videos for just that purpose! Click [here](../2020/90-sec/python-windows) to get started on Windows, or [here](../2020/90-sec/python-ubuntu) if you use Ubuntu.
