...
![type:video](https://www.youtube.com/embed/a72nZ0n_wd0)

Be sure to [sign up](https://pagekey.io/boom/signup) to get notified when the latest version of Boom is available!
...
Curious to try the new version? Sign up [**here**](https://pagekey.io/boom/signup) to get notified when it's available. There's even a chance you'll be selected as an exclusive private tester!
...
So, that's all for this Boom Languages brain dump. I hope you got something out of the lessons that I shared. If you want updates as I make progress, you can [**sign up for the mailing list**](https://pagekey.io/boom/signup) to get notified when new versions are available, and subscribe to the PageKey YouTube channel to stay in-the-know when we publish new videos. Thanks for reading!
