...
![Example of a Binary Search Tree](/img/1example_tree.png)
...
![Binary Search Tree: Insert method diagram](/img/2insert.png)
...
![Binary Search Tree: Find method diagram](/img/3find.png)
...
![Binary Search Tree: Remove method diagram, leaf node removal](/img/4remove.png)
<figcaption>Example of leaf node removale</figcaption>

![Binary Search Tree: Remove method diagram, non-leaf node removal](/img/5remove.png)
...
![Binary Search Tree: Pre-Order Traversal](/img/6pre_order.png)
...
![Binary Search Tree: In-Order Traversal](/img/7in_order.png)
...
![Binary Search Tree: Post-Order Traversal](/img/8post_order.png)
